  ...
  <div class="hd-top am-hide-md-down">
    <div class="cg">
      ...
      <div class="hd-top-right">
        <a href="file/register.html">注册</a>
        <a href="file/login.html">登录</a>
      </div>
    </div>
  </div>
  <div class="cg">
    ...
    <div class="cg">
      ...
      <div class="hd-bottom-nav" id="my-modal">
        ...
        <ul>
          ...
          <li><a href="pagingWebShop">模版中心</a></li>
          <li><a href="#">定制服务</a></li>
          <li><a href="#">成功案例</a></li>
          <li><a href="#">关于我们</a></li>
        </ul>
...
<div class="am-slider am-slider-default index-lunbo" data-am-flexslider="{playAfterPaused: 8000}">
  <ul class="am-slides">
    <li><img src="images/index_banner01.jpg" /></li>
    <li><img src="images/index_banner01.jpg" /></li>
    <li><img src="images/index_banner01.jpg" /></li>
  </ul>
      ...
      <div class="notice-left">
        ...
        <div class="notice-left-slider">
          <div class="am-slider am-slider-default am-slider-carousel"
            ...
            <ul class="am-slides">
              <li><img src="images/demo1.jpg" class="imgslider" data-clstag="baidu.com"/></li>
              <li><img src="images/demo11.jpg" class="imgslider"  data-clstag="yinyuetai.com"/></li>
              <li><img src="images/demo1.jpg" class="imgslider" data-clstag="yunalading.com"/></li>
              <li><img src="images/demo11.jpg" class="imgslider" data-clstag="google.cn"/></li>
            </ul>
          </div>
        </div>
      </div>
  ...
  <div class="cg">
    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
      ...
      <div class="am-slider am-slider-default am-slider-carousel"
        ...
        <ul class="am-slides">
          <li><a href="#"><img src="images/demo7.jpg" /><span>上汽股份旗下上海汽车中英文品牌命名</span></a></li>
          <li><a href="#"><img src="images/demo7.jpg" /><span>上汽股份旗下上海汽车中英文品牌命名</span></a></li>
          <li><a href="#"><img src="images/demo7.jpg" /><span>上汽股份旗下上海汽车中英文品牌命名</span></a></li>
          <li><a href="#"><img src="images/demo7.jpg" /><span>上汽股份旗下上海汽车中英文品牌命名</span></a></li>
          <li><a href="#"><img src="images/demo7.jpg" /><span>上汽股份旗下上海汽车中英文品牌命名</span></a></li>
